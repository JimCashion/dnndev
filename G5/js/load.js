var loadState = {
	...
	preload: function() {
        ...
        game.load.image('sky', '../assets/platformlight.png');
       
        game.load.image('ground', '../assets/platform.png');
        game.load.image('pen', '../assets/pen.png');
       // game.load.image('vgate', '../assets/vgate.png');
       // game.load.image('hgate', '../assets/hgate.png');

        game.load.image('star', '../assets/star.png');
        game.load.image('arrow1', '../assets/arrow1.png');
        game.load.image('arrow2', '../assets/arrow2.png');
        game.load.image('arrow3', '../assets/arrow3.png');
        game.load.image('fence_h', '../assets/fence_h.png');
        game.load.image('fence_v', '../assets/fence_v.png');
        game.load.image('cache', '../assets/cache.png');
        game.load.image('cachesmall', '../assets/cachesmall.png');
        game.load.spritesheet('dude', '../assets/dude.png', 32, 48);
        game.load.spritesheet('dudesmall', '../assets/dudesmall.png', 16, 24);
        ...
        game.load.spritesheet('stegsmall', '../assets/stegsmall.png', 32, 27);  //  pushy steg
